...
MapPoint::MapPoint(Eigen::Vector3d &worldPoint)
    : id(++nextMapPointId), worldPoint_(worldPoint), observationCount_(0) {}

const int16_t &MapPoint::getObservationCount() const {
